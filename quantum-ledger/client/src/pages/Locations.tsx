...
import { fmtCurrency, fmt, findStarCitizenGame } from '@/lib/utils';
import {
...
export function Locations() {
  ...
  const { data: locations = [], isLoading } = useQuery({
    queryKey: ['locations', scGameId],
    queryFn: () => locationsApi.list(scGameId ? { gameId: scGameId } : undefined),
  });
  ...
  const currency = scGame?.currency || 'UEC';
