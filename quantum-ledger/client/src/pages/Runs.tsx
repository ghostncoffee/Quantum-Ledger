...
import { fmtCurrency, fmtDuration, fmtDatetime, profitColor, RUN_TYPES, findStarCitizenGame } from '@/lib/utils';
...
function NewRunModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const [form, setForm] = useState({
    vehicleId: '', type: 'mining', title: '', location: '', notes: '', startNow: true,
  });
